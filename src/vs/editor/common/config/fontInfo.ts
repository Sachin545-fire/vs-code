 ...
 * @internal
 */
export const DEFAULT_WINDOWS_FONT_FAMILY = '\'JetBrains Mono\', \'Fira Code\', Consolas, \'Courier New\', monospace';
/**
 * @internal
 */
export const DEFAULT_MAC_FONT_FAMILY = '\'JetBrains Mono\', \'Fira Code\', Menlo, Monaco, \'Courier New\', monospace';
/**
 * @internal
 */
export const DEFAULT_LINUX_FONT_FAMILY = '\'JetBrains Mono\', \'Fira Code\', \'Droid Sans Mono\', monospace';
/**
 * @internal
 */
