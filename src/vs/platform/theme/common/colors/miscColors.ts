...
export const badgeBackground = registerColor('badge.background',
	{ dark: '#252830', light: '#C4C4C4', hcDark: Color.black, hcLight: '#0F4A85' },
...
export const badgeForeground = registerColor('badge.foreground',
	{ dark: '#a3e635', light: '#333', hcDark: Color.white, hcLight: Color.white },
...
export const scrollbarSliderBackground = registerColor('scrollbarSlider.background',
	{ dark: Color.fromHex('#ffffff').transparent(0.06), light: Color.fromHex('#646464').transparent(0.4), hcDark: transparent(contrastBorder, 0.6), hcLight: transparent(contrastBorder, 0.4) },
...
export const scrollbarSliderHoverBackground = registerColor('scrollbarSlider.hoverBackground',
	{ dark: Color.fromHex('#ffffff').transparent(0.1), light: Color.fromHex('#646464').transparent(0.7), hcDark: transparent(contrastBorder, 0.8), hcLight: transparent(contrastBorder, 0.8) },
...
export const scrollbarSliderActiveBackground = registerColor('scrollbarSlider.activeBackground',
	{ dark: Color.fromHex('#a3e635').transparent(0.25), light: Color.fromHex('#000000').transparent(0.6), hcDark: contrastBorder, hcLight: contrastBorder },
...
export const progressBarBackground = registerColor('progressBar.background',
	{ dark: Color.fromHex('#a3e635'), light: Color.fromHex('#0E70C0'), hcDark: contrastBorder, hcLight: contrastBorder },
