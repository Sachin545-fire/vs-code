...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide(preserveFocus?: boolean) {
		...
		const header = $('.header', {},
			$('h1.product-name.caption', {}, "ZEN LIME V5: ULTIMATE EDITION"),
			$('p.subtitle.description', {}, "Welcome to the future of coding. Auto-Zen Mode, Micro-Animations, and Acrylic Glass are fully active.")
		);
